...
object Dependencies {
  ...
  val fs2Sqs =
    "io.laserdisc" %% "fs2-aws-sqs" % fs2S3.revision

  val healthCheck =
    "com.rewardsnetwork" %% "healthcheck" % "2.0.57"

  val http4s =
    "org.http4s" %% "http4s-core" % "0.23.15"

  val http4sDsl =
    "org.http4s" %% "http4s-dsl" % http4s.revision

  val http4sEmberServer =
    "org.http4s" %% "http4s-ember-server" % http4s.revision

  val http4sPlayJson =
    "org.http4s" %% "http4s-play-json" % http4s.revision

  val h2db =
    "com.h2database" % "h2" % "2.3.232"

  val kafkaUtils =
    "com.rewardsnetwork" %% "kafka-utils" % "2.1.10"
  ...
  val slickHikaricp =
    "com.typesafe.slick" %% "slick-hikaricp" % slick.revision

  val sttp =
    "com.softwaremill.sttp.client3" %% "core" % "3.11.0"

  val sttpClient =
    "com.softwaremill.sttp.client3" %% "async-http-client-backend-cats" % sttp.revision
